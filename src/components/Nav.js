...
import { BsClipboradData, BiSolidBriefcase, BsChatSquare, BsBriefcase, BsChatSquareText } from 'react-icons/bs';
...
const Nav = () => {
  return (
    <nav nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
      <div className="container mx-auto">
        ...
        rounded-full max-w[460px] mx-auto px-5 flex justify-between items-center text-2xl text-white/50'>
          ...
          <Link
            ...
            className='cursor-pointer w-[60px] h-[60px] flex items-center 
            justify-center'>
            <BiClipboard className='cursor-pointer' />
          </Link>
